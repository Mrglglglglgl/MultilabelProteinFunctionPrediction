...
the best f1 in the validation set was achieved using the ranking loss
"""
...
for branch_number, branch in enumerate(branch_list):
	...
	copyfile(pt_path, '/cluster/project1/FFPredRNN/MLDNN/' + str(branch.go_term) + 'LTR_only_margin_' + margin + '.pt')
	file = open('/cluster/project1/FFPredRNN/MLDNN/' + str(branch.go_term) + 'trained_LTR_only_margin_' + margin + '.pickle', 'wb')
